...
class GeoCyl extends THREE.Geometry {

    constructor({ rmax, dz, twist, numSegs }) {
        super();
        this.parameters = { rmax, dz, twist, numSegs };
        this.type = 'GeoCyl';
        this.fromBufferGeometry( new GeoCylBuffer({ rmax, dz, twist, numSegs }) );
    }
...
class GeoCylBuffer extends THREE.BufferGeometry {
    ...
    constructor({ rmax = 20, dz = 40, twist = false, numSegs = 12 }) {
        ...
        let vertices = [], // 3 entries per vector
        	...
        	PI2 = Math.PI * 2, i, DX = rmax, DY = rmax,
			offset1, offset2;
