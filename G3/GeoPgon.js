...
class GeoPgon extends THREE.Geometry {

    constructor({ phi1, dphi, nz, z, rmin, rmax, npdv }) {
        super();
        this.parameters = { phi1, dphi, nz, z, rmin, rmax, npdv };
        this.type = 'GeoPgon';
        this.fromBufferGeometry( new GeoPgonBuffer({ phi1, dphi, nz, z, rmin, rmax, npdv }) );
    }

}

class GeoPgonBuffer extends THREE.BufferGeometry {
